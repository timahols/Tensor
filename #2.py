...
class Images:
    ...
    def menu_display(self):
        ...
        assert all_services.is_displayed(), "Меню не отображается на странице"
        all_services.click()
    ...
    def transition_images(self):
        ...
        assert self.driver.current_url == 'https://yandex.ru/images/', "Ошибка: не открывался сайт Яндекс.Картинки"
    ...
    def first_category(self):
        ...
        assert text_the_first_1 == search_field_result_2, 'Ошибка: первая категория не найдена'
    ...
    def next(self):
        ...
        image_element = driver.find_element(By.CLASS_NAME, "MMImage-Origin").get_attribute('src')
        next.click()
        new_image_element = driver.find_element(By.CLASS_NAME, "MMImage-Origin").get_attribute('src')
    ...
    def back(self):
        ...
        assert image_element == self.driver.find_element(By.CLASS_NAME, "MMImage-Origin").get_attribute(
            'src'), "Ошибка: картинка не вернулась"
